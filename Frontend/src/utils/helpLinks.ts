...
const routeHelpMap: Record<string, string> = {
  ...
  '/files': '03-fluxo-operacional/editor-cad/',
  '/viewer': '04-memorial/visualizador-normas-e-geracao/',
  '/viewer-document': '04-memorial/visualizador-normas-e-geracao/',
  '/cad-editor': '03-fluxo-operacional/editor-cad/',
  '/test-viewer': '04-memorial/visualizador-normas-e-geracao/',
  '/report': '04-memorial/visualizador-normas-e-geracao/',
