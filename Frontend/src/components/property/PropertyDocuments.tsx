  ...
  return (
    <div className="property-documents">
      <div className="section-header">
        <h2>📄 Documentos de Apoio do Imovel</h2>
        <p className="section-description">
          Registre aqui os documentos que ajudam a deixar a preparacao do imovel mais completa.
        </p>
      </div>
      ...
      {showAddForm ? (
        <div className="document-form">
          <h4>➕ Adicionar Documento de Apoio</h4>
      ...
      {documents.length === 0 && (
        <div className="empty-state">
          ...
          <p>Documentos sao opcionais, mas ajudam a deixar a preparacao do imovel mais consistente.</p>
        </div>
      )}
    </div>
  );
